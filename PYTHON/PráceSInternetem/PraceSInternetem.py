...
zacatek = re.search(r"* START OF THE PROJECT GUTENBERG EBOOK OTHELLO, THE MOOR OF VENICE *", obsah).end()
konec = re.search(r"* END OF THE PROJECT GUTENBERG EBOOK OTHELLO, THE MOOR OF VENICE *", obsah).start()
